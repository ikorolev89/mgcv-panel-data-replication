...
#   Rscript simulations/panel_fe_g_inference_coverage.R 50 200 4 sin_2pi both 50 499 hetero_ar1 0.5
#
# Arguments:
...
summary_base <- aggregate(
  cbind(point_covered, point_width, uniform_covered, uniform_width, sup_crit) ~ model + method + se_type,
  data = results,
  FUN = mean
)
