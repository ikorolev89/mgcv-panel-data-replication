...
main <- function() {
  ...
  cases <- list(
    ...
    list("simulations/inference_diagnostics/panel_fe_g_inference_diagnostics_chunk.R", c(2, 40, 4, "sin_2pi", "both", 10, 99, "hetero_ar1", 0.5, "substantive", 20260505, "smoke"))
  )
  ...
  cat("All nine simulation smoke cases passed.\n")
}
main()
